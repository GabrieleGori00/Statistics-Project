...
n_hurricane <- 1000
answers_hurricane <- sample(answers, n_hurricane, replace = TRUE, prob = c(0.25, 0.25, 0.25, 0.25))
```
```{r}
# Generate answers for those who did not witness a natural disaster
n_no_hurricane <- 1000
answers_no_hurricane <- sample(answers, n_no_hurricane, replace = TRUE, prob = c(0.25, 0.25, 0.25, 0.25))
